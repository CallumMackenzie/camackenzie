			...
			<div className='row py-2 px-1 justify-content-center'>
				<div className={(smallScreen ? "col-11" : "col-6") + " container text-center"}>
					...
					<p className='text-start py-1'
						...
						I will be joining <b>Amazon as a Software Development Engineer Intern</b> in Vancouver this summer. I am a current undergraduate student at the University of British Columbia, and an on-call Embedded Software Engineer Co-op with <b>General Dynamics</b>.
						<div className='py-2'>
							<Divider sx={{
								background: 'white'
							}} />
